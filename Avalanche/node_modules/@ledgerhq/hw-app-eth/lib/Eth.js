            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, contracts_1.loadInfosForContractMethod)(decodedTx.to, selector, chainIdTruncated, this.pluginsLoadConfig)];
                    case 1:
                        infos = _b.sent();
                    ...
                    case 14:
                        _b.sent();
                        _b.label = 15;
                    case 15: return [2 /*return*/, (0, utils_1.foreach)(toSend, function (data, i) {
