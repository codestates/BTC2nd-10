...
export declare class PlatformVMAPI extends JRPCAPI {
     ...
     */
    buildAddSubnetValidatorTx: (utxoset: UTXOSet, fromAddresses: string[], changeAddresses: string[], nodeID: string, startTime: BN, endTime: BN, weight: BN, subnetID: any, subnetAuth: any, memo?: PayloadBase | Buffer, asOf?: BN) => Promise<UnsignedTx>;
    /**
